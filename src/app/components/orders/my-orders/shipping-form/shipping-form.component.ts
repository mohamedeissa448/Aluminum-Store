...
import { MatDialogRef, MAT_DIALOG_DATA, MatAutocompleteSelectedEvent,MatChipInputEvent, MatDialogConfig, MatDialog } from '@angular/material';
import {FormControl, NgForm} from '@angular/forms';
import {Observable, of} from 'rxjs';
import { AuthService } from '../../../../authentication/services/auth.service';
import { MyOrderService } from '../../services/my-order.service';
import { NotificationService } from '../../../shared/services/notification.service';
import { CallNoteComponent } from '../call-note/call-note.component';
...
export class ShippingFormComponent implements OnInit {
  ...
  Order_ShippingWaybill : Array<String> = [];
  shippingCompanies :any =[];
  Order_Shipping_Employee_Main_Note  : any = "";
...
/*******filter customer */
  ...
  InsertIntoOrder(CustomerID){
    let DataToSend :any={
      ...
      Order_Shipping_Employee_Main_Note : this.Order_Shipping_Employee_Main_Note,
  ...
  addCallNote(){
    ...
    dialogConfig.data = { title: "Customer's Call Note",id : this.id };

    let dalogRef=this.dialog.open(CallNoteComponent, dialogConfig);
    dalogRef.afterClosed().subscribe((data)=>{

    })
  }

  addShippingWaybill(shippingBill : HTMLInputElement){
    this.Order_ShippingWaybill.push(shippingBill.value);
    shippingBill.value = "";
    console.log("this.Order_ShippingWaybill",this.Order_ShippingWaybill)
  }

  removeShippingWaybill(shippingBill : String){
    this.Order_ShippingWaybill.splice(this.Order_ShippingWaybill.indexOf(shippingBill),1)
    console.log("this.Order_ShippingWaybill",this.Order_ShippingWaybill)
