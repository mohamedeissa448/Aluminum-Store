...
export class ReasonOfCancelOrderService {
  ...
  constructor(private http: HttpClient) {
    this.form = new FormGroup({
      ...
      ReasonOfCalcelation_CanBeFollowedUp: new FormControl("",[Validators.required]),
  ...
  addReason(newReason) {
    ...
    return this.http
      .post(`${systemSettings.serverURL}/sys-setup/cancel-reasons/addCancelReason`, {
        ...
        ReasonOfCalcelation_CanBeFollowedUp : newReason.ReasonOfCalcelation_CanBeFollowedUp,
      })
      .pipe(
        map((response: any) => {
  ...
  updateReason(updatedReason,id) {
   ...
   return this.http
      .post(`${systemSettings.serverURL}/sys-setup/cancel-reasons/editCancelReasonById`, {
        ...
        ReasonOfCalcelation_CanBeFollowedUp: updatedReason.ReasonOfCalcelation_CanBeFollowedUp,
  ...
  popualteForm(ourReason) {
    ...
    this.form.setValue({
      ...
      ReasonOfCalcelation_CanBeFollowedUp:ourReason.ReasonOfCalcelation_CanBeFollowedUp || "",
