...
export class SupplierPaymentsService {
  ...
  getSupplierFinancialTransactionsByID(_id){
    return this.http.post(`${systemSettings.serverURL}/suppliers/getAllSupplierTransactions`,{_id})
  }

  deleteTransactionFromFinancialTransactions(dataToSend){
    return this.http
    .post(`${systemSettings.serverURL}/suppliers/deleteTransactionFromFinancialTransactions`, dataToSend)
    .pipe(
      map((response: any) => {
        if (response.message == true) return true;
        return false;
