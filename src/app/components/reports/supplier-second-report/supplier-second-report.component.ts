...
@Component({
  selector: 'app-supplier-second-report',
  templateUrl: './supplier-second-report.component.html',
  styleUrls: ['./supplier-second-report.component.css']
})
export class SupplierSecondReportComponent implements OnInit {
  ...
  searchdataBySupplierId(){
    ...
    this.SupplierReportService.getAllSupplierPayments({ _id :this.supplierCtrl.value._id }).subscribe((supplierPayments: any) => {
      this.isLoading = false;
