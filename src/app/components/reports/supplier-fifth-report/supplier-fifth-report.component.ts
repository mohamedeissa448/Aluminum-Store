...
@Component({
  selector: 'app-supplier-fifth-report',
  templateUrl: './supplier-fifth-report.component.html',
  styleUrls: ['./supplier-fifth-report.component.css']
})
export class SupplierFifthReportComponent implements OnInit {
  ...
  searchdataBySupplierId(){
    ...
    this.SupplierReportService.getAllSupplierBillsAndBillReturned({  _id :this.supplierCtrl.value._id ,}).subscribe((DatafromServer: any) => {
